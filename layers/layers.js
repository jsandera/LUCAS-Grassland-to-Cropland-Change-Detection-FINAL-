...
var format_LUCASPoints_2 = new ol.format.GeoJSON();
var features_LUCASPoints_2 = format_LUCASPoints_2.readFeatures(json_LUCASPoints_2, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_LUCASPoints_2 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_LUCASPoints_2.addFeatures(features_LUCASPoints_2);
var lyr_LUCASPoints_2 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_LUCASPoints_2, 
                style: style_LUCASPoints_2,
                popuplayertitle: 'LUCAS Points',
                interactive: true,
                title: '<img src="styles/legend/LUCASPoints_2.png" /> LUCAS Points'
            });

lyr_OpenStreetMap_0.setVisible(true);lyr_AdministrativeBorders_1.setVisible(true);lyr_LUCASPoints_2.setVisible(true);
var layersList = [lyr_OpenStreetMap_0,lyr_AdministrativeBorders_1,lyr_LUCASPoints_2];
...
lyr_LUCASPoints_2.set('fieldAliases', {'point_id': 'point_id', 'survey_dat': 'survey_dat', 'survey_d_1': 'survey_d_1', 'survey_d_2': 'survey_d_2', 'survey_d_3': 'survey_d_3', 'Change Vec': 'Change Vec', 'EVI': 'EVI', 'NDVI': 'NDVI', 'NDWI': 'NDWI', 'SP_INDICES': 'SP_INDICES', 'SP_BANDS': 'SP_BANDS', 'X_Coordina': 'X_Coordina', 'Y_Coordina': 'Y_Coordina', 'CH_TYPE': 'CH_TYPE', });
...
lyr_LUCASPoints_2.set('fieldImages', {'point_id': 'TextEdit', 'survey_dat': 'DateTime', 'survey_d_1': 'DateTime', 'survey_d_2': 'DateTime', 'survey_d_3': 'DateTime', 'Change Vec': 'TextEdit', 'EVI': '', 'NDVI': '', 'NDWI': '', 'SP_INDICES': '', 'SP_BANDS': '', 'X_Coordina': '', 'Y_Coordina': '', 'CH_TYPE': '', });
...
lyr_LUCASPoints_2.set('fieldLabels', {'point_id': 'inline label - always visible', 'survey_dat': 'inline label - always visible', 'survey_d_1': 'inline label - always visible', 'survey_d_2': 'inline label - always visible', 'survey_d_3': 'inline label - always visible', 'Change Vec': 'inline label - always visible', 'EVI': 'inline label - always visible', 'NDVI': 'inline label - always visible', 'NDWI': 'inline label - always visible', 'SP_INDICES': 'inline label - always visible', 'SP_BANDS': 'inline label - always visible', 'X_Coordina': 'hidden field', 'Y_Coordina': 'hidden field', 'CH_TYPE': 'inline label - always visible', });
lyr_LUCASPoints_2.on('precompose', function(evt) {
